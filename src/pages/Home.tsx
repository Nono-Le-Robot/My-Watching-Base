                    ...
                    <>
                        {showChangeNameModal && (
                            <div id="modal-change-name">
                                <input
                                    ...
                                    placeholder=""
                                    onChange={(event) =>
                                        handleChangeImage(event.target.value)
                                    }
                                ></input>
                                <input
                                    autoComplete="nope"
                        ...
                        {!showAddRequestModal && (
                            <>
                                <div id="nav">
                                    <p
                                        className="toggle-series-movies"
                                        onClick={showSeries}
                                    >
                                ...
                                {/* <select
                                    onChange={(event) => {
                                        ...
                                        let filteredMoviesByGender =
                                            groupedByMovies.filter((movie) =>
                                                movie.gender.includes(
                                                    selectedGender
                                                )
                                            );
                                        setMovieList(filteredMoviesByGender); // Mettez à jour l'état ou la variable contenant la liste des films filtrés
                                        let filteredSeriesByGender =
                                            groupedBySerie.filter((serie) =>
                                                serie[0].gender.includes(
                                                    selectedGender
                                                )
                                            );
                        ...
                        {showAddRequestModal && (
                            <div id="request-new-modal">
                                <div id="inputs-modal-new">
                                    ...
                                    >
                                        Try to be precise as possible. Requests
                                        that are not sufficiently precise will
                                        not be processed.
                                    </p>
                                    <input
                                        autoComplete="nope"
