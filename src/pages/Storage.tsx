      ...
      .then((response) => {
        ...
        files.forEach((file) => {
          ...
          if (isVideo) {
            ...
            const motsCapitalises = mots.map(
            ...
            data.map((video, index) => (
              ...
              >
                ...
                {video.isMovie || video.isSerie ? (
                  <p className="episode">
                    {video.episode} - {video.episodeNameTMDB}
                  </p>
                ) : (
...
{
  /* <p className="episode">{filteredMovies[0] ? filteredMovies[0].formatedMovieName : "Loading..."}</p> */
}
// CSS
